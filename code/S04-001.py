...
# absolute frequencies using NumPy
...
rel_freq_np = abs_freq_np.copy().astype("float")
rel_freq_np[:,1] = rel_freq_np[:,1] / N
print("\n", "--"*5, "\n")
print("Relative frequencies with NumPy:\n")
print(rel_freq_np)

# using stats from scipy
rel_freq_np = scp.stats.relfreq(dice, numbins=n).frequency
print("\n", "--"*5, "\n")
print("Relative frequencies using Scipy Stats:\n")
